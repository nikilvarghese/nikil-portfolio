...
const ImageCard = ({ src, alt, caption, containerClassName = "bg-black/50", imgClassName = "w-full h-auto object-contain" }: { src: string, alt: string, caption: string, containerClassName?: string, imgClassName?: string }) => (
  <div className="group flex flex-col gap-4 h-full">
    <div className={`rounded-xl overflow-hidden border border-slate-800/80 bg-[#0a0f1d] shadow-lg relative flex items-center justify-center ${containerClassName}`}>
    ...
    <p className="text-base text-slate-400 px-1 border-l-2 border-blue-500/50 pl-3 group-hover:text-slate-300 transition-colors mt-auto">{caption}</p>
  </div>
);
            ...
            <div className="project-block mt-6">
              <div className={`bg-slate-900 border ${vmwareOpen ? 'border-blue-500/50 shadow-[0_0_30px_rgba(59,130,246,0.15)]' : 'border-slate-800 shadow-2xl hover:border-slate-700'} transition-all duration-500 rounded-2xl p-8 lg:p-12 relative overflow-hidden group`}>
                ...
                <motion.div
                  ...
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  className="rounded-xl overflow-hidden border border-slate-700/50 shadow-2xl relative group bg-[#0a0f1d] p-1 lg:p-2"
                >
                  <div className="absolute inset-0 bg-blue-500/0 group-hover:bg-blue-500/10 transition-colors duration-500 z-10 pointer-events-none" />
                  <img src={infrastructureArchitecture} alt="Infrastructure Architecture" className="w-full max-h-[700px] object-contain transform group-hover:scale-[1.02] transition-transform duration-700 rounded-lg shadow-xl mx-auto" />
                </motion.div>
                ...
                <div className="space-y-20">
                  ...
                  >
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                      ...
                      <div className="lg:col-span-7 rounded-xl overflow-hidden shadow-2xl border border-slate-700/50 relative group bg-black/50 p-2 flex items-center justify-center min-h-[300px]">
                        <img src={vmwareDashboard} alt="VMware Dashboard" className="w-full h-full object-contain transform group-hover:scale-[1.02] transition-transform duration-500 rounded-lg" />
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
                      <ImageCard
                        ...
                        containerClassName="aspect-[16/10] bg-black/50 p-2"
